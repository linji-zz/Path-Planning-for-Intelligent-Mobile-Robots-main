...
EXPS = [
    ...
    ('dqn_A1_no_openness_10000.pth', 'A1: Coupled Minus Openness',  '10000', False),
    ('dqn_A2_no_alignment_10000.pth','A2: Coupled Minus Alignment', '10000', False),
]

print('=' * 85)
print('FINAL COMPARISON | 15x15 Grid | 200 greedy episodes')
print('=' * 85)
print('{:<30} {:<8} {:<10} {:<10}'.format('Model', 'Eps', 'Success', 'Steps'))
print('-' * 85)
...
print('=' * 85)
print()
print('Training Reward (from training logs):')
print('  E0: ~74.6   E1: ~83.9  (+12.5%)')
print('  A1: ~77.9   A2: ~76.9  (lower than E1)')
print('  E2: ~85-88 (5500 eps, approaching E1 level)')
